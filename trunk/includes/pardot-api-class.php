...
class Pardot_API {
	 ...
	 * 	%%ITEM_TYPE%%: One of 'account', 'campaign' or 'form'.
...
x	 */
	 ...
	 *
	 * @param string $item_type One of 'account', 'campaign' or 'form'.
	 ...
	 *
	 * @param string $item_type Item type requested; 'account', 'form', and 'campaign' tested.
